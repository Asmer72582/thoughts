...
<div class="container text-warning">
   ...
   <div class="content m-4 bg-white text-warning pb-3 rounded" style="border: 1px solid;">
      <h3 class="p-3 text-white bg-warning">New Notifications</h3>
      <br>
...
<?php 
      ...
      <span class="text-bold"><b><a class="text-warning" href="profileshow.php?id=<?php echo $show; ?>"><?php echo $result['from_user']; ?></a></b></span>
      <span style="color: black;"><?php echo " Comment on your poem ";?> on </span>
      <span>-<?php echo $result['post_id']; ?>-</span>
      ...
      <hr class="text-warning bg-warning">
      <span class="text-bold"><b><a class="text-warning" href="profileshow.php?id=<?php echo $show; ?>"><?php echo $result['from_user']; $nameofuser = $result['from_user'];?></a></b></span>
    ...
    <!--// unseen -->
      ...
      <div class="content m-4 bg-white text-warning pb-3 rounded" style="border: 1px solid;">
        <h3 class="p-3 text-white bg-warning">Old Notifications</h3>
        <br>
        <div class="px-3 " style="font-size: 18px;">
    ...
    $nameofuser = $result['from_user'];
      ...
      <hr class="text-warning bg-warning">
      <span class="text-bold"><b><a class="text-warning" href="profileshow.php?id=<?php echo $nameofuser; ?>"><?php echo $resu2lt['from_user']; $nameofuser = $resu2lt['from_user'];?></a></b></span>
      <span style="color: black;"><?php echo " like your poem"; ?> on </span>
      <span><?php echo $resu2lt['post_id']; ?> </span>
      ...
      ?> 
        <hr class="text-warning bg-warning">
        <span class="text-bold"><b><a class="text-warning" href="profileshow.php?id=<?php echo $nameofuser; ?>"><?php echo $result['from_user'];?></a></b></span>
        <span style="color: black;"><?php echo " Comment on your poem"; ?> on </span>
        <span><?php echo $result['post_id']; ?> </span>
        <span>-'</span><span style="color: black;"><?php echo $result['comment']; ?></span>'<br>
